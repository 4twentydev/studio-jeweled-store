      ...
      <div className="grid gap-4 p-4 sm:grid-cols-[124px_1fr]">
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {item.hasMetadataGaps ? (
              <Badge variant="secondary">Needs metadata</Badge>
            ) : null}
            {item.isSold ? (
  ...
  const filters = {
    ...
    category:
      typeof resolvedSearchParams.category === "string"
        ...
        : undefined,
    quantity:
      typeof resolvedSearchParams.quantity === "string"
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        <div>
          ...
          <p className="mt-2 max-w-3xl text-sm text-muted-foreground">
            Track stock, publishing readiness, metadata gaps, and item value
            across the studio catalog.
          </p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <StatCard
          ...
          hint="All active inventory records"
        />
        <StatCard
          label="Drafts"
          value={stats.drafts}
          hint="Still being staged or edited"
        />
        <StatCard
          label="Approved"
          value={stats.approved}
          hint="Ready for publishing or release"
        />
        <StatCard
          label="Published"
        ...
        <StatCard
          label="Sold"
          value={stats.sold}
          hint="Marked sold or no longer available"
        />
        <StatCard
          label="Low quantity"
          value={stats.lowQuantity}
          hint={`At or below ${lowStockThreshold} on hand`}
        />
        <StatCard
          ...
          <CardContent className="grid gap-3 p-5">
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                Approved items still waiting to be published
              </p>
            </div>
            <div className="rounded-[1.25rem] border bg-black/20 p-3">
              <p className="text-sm text-muted-foreground">
                {metadataGapCount} filtered items need metadata cleanup.
              </p>
            </div>
          </CardContent>
        </Card>
          ...
          <form className="grid gap-4 lg:grid-cols-2 xl:grid-cols-4">
            <div className="xl:col-span-2">
              ...
              <Input
                ...
                placeholder="Search title, SKU, tags, category"
              />
            </div>
            <div>
              <label
          ...
          <CardHeader className="flex flex-col gap-4 border-b bg-white/3 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Select items to move them through approval, archive old records,
                mark sold pieces, or export catalog data.
              </p>
            </div>
            <div className="flex flex-wrap gap-2">
              <Button
                formAction={approveSelectedProductsAction}
                size="sm"
                type="submit"
              >
                Approve selected
              ...
              <Button
                formAction={archiveSelectedProductsAction}
                size="sm"
                type="submit"
                variant="secondary"
              >
              ...
              <Button
                formAction={markSelectedSoldAction}
                size="sm"
                type="submit"
                variant="outline"
              >
              ...
              <Button
                formAction={generateSelectedMetadataAction}
                size="sm"
                type="submit"
                variant="outline"
              >
